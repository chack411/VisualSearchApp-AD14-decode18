namespace VisualSearchApp
{
    public static class AppConstants
    {
        ...
        {
            ComputerVisionApiOcrUrl = $"https://{location}.api.cognitive.microsoft.com/vision/v1.0/ocr?detectOrientation=true";
        ...
        #region custom vision api
        public static string CustomVisionApiKey = "";
        public static string CustomVisionApiUrl = "";
        #endregion
    }
}
